...
namespace
{
    constexpr qreal square_side = 50.;
    constexpr qreal radius = 30.;
    constexpr qreal triangle_side = 80.;
    constexpr qreal ellipse_d1 = 30.;
    constexpr qreal ellipse_d2 = 50.;
    constexpr qreal rhombus_d1 = 80.;
    constexpr qreal rhombus_d2 = 40.;
    constexpr qreal rect_width = 80.;
    constexpr qreal rect_heigh = 20.;
    constexpr qreal star_size = 90.;
